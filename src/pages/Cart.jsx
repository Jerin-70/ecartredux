        ...
        <div className='col-span-2 border rounded p-5 shadow '>
          <table className='table-auto w-full'>
            ...
            <tbody>
              <td>1</td>
              <td>Product Name </td>
              <td><img width={'70px'} height={'70px'} src='https://www.boat-lifestyle.com/cdn/shop/files/ACCG6DS7WDJHGWSH_0.png?v=1727669669' alt=''/></td>
              <td> 
                <div className='flex'>
                  <button className='font-bold'>-</button>
                  <input style={{width:"40px"}} type="text" className='border p-1 rounded mx-2' value={12}
                  readOnly />
                  <button className='font-bold'>+</button>
