...
const cartSlice = createSlice({
    ...
    reducers:{
        ...
        increamentQuantity : (state,actionByCart)=>{
        ...
        removecartItem:(state,actionByCart)=>{
         ...
         decereamentQuantity : (state,actionByCart)=>{
            const existingProduct = state.find(item=>item.id == actionByCart.payload)
            existingProduct.quantity--
            existingProduct.totalPrice = existingProduct.quantity * existingProduct.price
            const remainingproducts = state.filter(item=>item.id !=existingProduct.id)
...
export const {addTocart,increamentQuantity,removecartItem,decereamentQuantity,emptyCart} = cartSlice.actions
